...
export const prologue = {
  ...
  chinese: {
    ...
    content: [
      ...
      `十三岁那年，诺亚去世了。孤身一人的乐乐华开始在街头流浪。后来，他被夏威夷莉莉乌欧卡拉尼儿童基金会（Queen Lili'uokalani Children's Trust）的工作人员发现，并被安置在檀香山（Honolulu）的"夏威夷受伤孩子之家"孤儿院（Hawaiian Kids Hurt Too orphanage）。`,
