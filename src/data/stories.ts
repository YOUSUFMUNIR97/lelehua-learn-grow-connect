...
export const prologue = {
  chinese: {
    title: "序章: 乐乐华的人生旅程",
    content: [
      "乐乐华出生在艰难的环境中。刚出生就被遗弃的他，被一位名叫 Noa(诺亚)的无家可归者在夏威夷茂宜岛(Kahului, Hawaii)的垃圾回收中心(Central Maui Landfill Refuse and Recycling Centre)发现。听到婴儿的哭声，诺亚心生怜悯，把他抱回去照顾。",
      "诺亚给他取名为 Lelehua，在夏威夷语中意为"善于运用智慧的人"。诺亚希望，乐乐华能靠智慧和善良，去创造一个更美好的世界。",
      ...
      "在义工马大妈的照顾下，乐乐华终于有了家、有了未来、有了归属感。他也获得了中文名字乐乐华，不仅保留了夏威夷名字的韵味，也带有温柔、优雅的中文意蕴——"乐在华文 / enjoying Chinese"，寓意他对语言的喜爱和文化的热情。",
